...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> create(BookingDto requestDto, long userId) {
    ...
    public ResponseEntity<Object> setApproved(int userId, int bookingId, boolean approved) {
